...
# The code in this file makes figure 5

# In this file I am going to try making a diagram which incorporates the 3BNC117
# haplotypes and their frequencies. This version is discretized

info_indir = '../../../results/pub_figs_07-2025/figure_5/hap_freq_diags/'
hap_info_path = info_indir + "hap_info_df.csv"
inDir_3BNC = '../../../data/clyde_westfall_2024_final/3BNC117/'

outDir = '../../../results/pub_figs_07-2025/figure_5/hap_freq_diags/'
