...
#The code in this file makes the dataframe supporting figure 5
...
outFolder = 'hap_freq_diags/'
outDir = '../../../results/pub_figs_07-2025/figure_5/'
...
fig4_summary_df = fig4_summary_df[fig4_summary_df['method'] != 'additional_sites']
...
# print(outDir + outFolder + 'hap_info_df.csv')
# #Check that the percentages sum to 1
# for name, group in all_hap_info_df.groupby(['time_label_int', 'participant']):
#     if np.sum(group['hap_freq']) < 0.9999 or np.sum(group['hap_freq']) > 1.0001:
#         print(name)
#         print(np.sum(group['hap_freq']))
#         print('------------------------')
#     else:
#         print('Good')