...
#Three wide (5.44, 1.75)
#Four wide (7.08, 1.75)

#The code in this panel produces figure 3 panels h,i

params = {'figure.figsize': (4.76, 1.75), 'axes.labelsize': 6,'axes.titlesize':6,  
...
# par_list = ['1HD10K', '1HD1', '1HB3']#, '1HC2']
...
###############################################################################
fig, axs = plt.subplots(1, len(par_list))
axs = axs.flatten()
...
plt.subplots_adjust(bottom=0.2, left= 0.08, right = 0.98, wspace = 0.05)
plt.savefig(outDir + 'lineage_escape_bars_3_row.png', dpi = 300)
plt.close()